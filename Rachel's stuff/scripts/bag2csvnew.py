...
for bagFile in listOfBagFiles:
	...
	#shutil.copyfile(bagName, folder + '/' + bagName)
        #note that here you can also not copy file so that you reduce the amount of bags there are

	#get list of topics from the bag
        #here just append listOfTopics as the topics that you want: reduce number of topics
	#listOfTopics = ["/imu/data", "/force_sensor_topic", '/camera/color/image_raw']
        listOfTopics = ["/3d_data"]
